...
const certificates = [
  { title: 'Python Essentials 1', file: 'https://github.com/KorraPraveen82/MyPortfolio/blob/main/Python_Essentials_1_certificate_korrapraveenstar55385-gmail-com_664e9b26-d8fa-48bc-a017-ae6226dd12b0.pdf' },
...
export default function Home() {
  return (
    <main>
      ...
      <header className="nav-shell"><nav className="nav container" aria-label="Primary navigation"><a className="brand" href="#top">KP<span>.</span></a><div className="nav-links"><a href="#about">About</a><a href="#skills">Skills</a><a href="#projects">Work</a><a href="#certificates">Certificates</a><a href="#contact">Contact</a></div><a className="nav-cta" href="mailto:praveenkorra9608@gmail.com">Let&apos;s talk ↗</a></nav></header>
      <div id="top" className="hero-wrap"><section className="hero container"><div className="hero-copy"><p className="eyebrow"><span /> AVAILABLE FOR OPPORTUNITIES</p><p className="hero-kicker">CSIT STUDENT · DEVELOPER IN PROGRESS</p><h1>Learning today,<br /><em>building tomorrow.</em></h1><p className="lead">I&apos;m <strong>K. Praveen</strong>, a 3rd-year BTech CSIT student at Sree Datta Engineering and Science. I&apos;m building a practical foundation in development while moving toward <strong>Data Analysis</strong> and <strong>Game Development</strong>.</p><div className="hero-actions"><a className="btn btn-primary" href="#projects">See what&apos;s next <span>↓</span></a><a className="text-link" href="/resume">Open resume ↗</a></div></div><aside className="hero-visual" aria-label="Profile snapshot"><div className="profile-card"><div className="profile-top"><span>PROFILE / 01</span><span>HYDERABAD, INDIA</span></div><div className="monogram">KP<span>.</span></div><div className="profile-bottom"><div><span>DEGREE</span><strong>BTech · CSIT</strong></div><div><span>SGPA</span><strong>7.90</strong></div><div><span>YEAR</span><strong>03</strong></div></div></div><p className="hero-note">Small steps. Useful projects. Continuous learning.</p></aside></section></div>
      <section id="about" className="section container split-section"><div className="section-label"><span>01</span><span>ABOUT</span></div><div className="section-content"><p className="section-intro">I&apos;m focused on turning what I learn into work I can actually show.</p><div className="about-grid"><p>My current focus is building strong programming and web fundamentals while exploring where I can go next. I&apos;m especially interested in data analysis and game development, and I want my portfolio to grow alongside my skills — honestly, project by project.</p><div className="about-aside"><span>EDUCATION</span><strong>BTech · CSIT</strong><span>COLLEGE</span><strong>Sree Datta Engineering and Science</strong><span>STATUS</span><strong>3rd year · 5th semester</strong></div></div></div></section>
